...
class WorkflowsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IPAAS\Workflows', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\IPAAS\Workflows', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IPAAS\Workflows', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IPAAS\Workflows', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\IPAAS\Workflows', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\IPAAS\Workflows', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IPAAS\Workflows', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\IPAAS\Workflows', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IPAAS\Workflows', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IPAAS\Workflows', $model);
    }
