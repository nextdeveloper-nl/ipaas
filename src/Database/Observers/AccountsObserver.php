...
class AccountsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IPAAS\Accounts', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\IPAAS\Accounts', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IPAAS\Accounts', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IPAAS\Accounts', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\IPAAS\Accounts', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\IPAAS\Accounts', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IPAAS\Accounts', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\IPAAS\Accounts', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IPAAS\Accounts', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IPAAS\Accounts', $model);
    }
