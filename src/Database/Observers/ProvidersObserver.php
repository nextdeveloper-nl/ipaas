...
class ProvidersObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\IPAAS\Providers', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\IPAAS\Providers', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\IPAAS\Providers', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\IPAAS\Providers', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\IPAAS\Providers', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\IPAAS\Providers', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\IPAAS\Providers', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\IPAAS\Providers', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\IPAAS\Providers', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\IPAAS\Providers', $model);
    }
